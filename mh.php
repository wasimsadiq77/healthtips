...
$result = mysqli_query($link,"SELECT * FROM complaint where type='mobile health' ");
...
<body id="page-top">
  ...
  <th><a href="https://wa.me/9972002179text=hey how may i help u"><button>Chat</button></a> </th>
  </tr>
  <?php
  $i++;
  }
